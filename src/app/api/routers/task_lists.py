...
def create_list(list_data: TaskListCreate, db: Session = Depends(get_db)) -> TaskList:
    """
...
@router.get("/{list_id}", response_model=TaskList, summary="Obtener una lista de tareas")
def get_list(
...
@router.put("/{list_id}", response_model=TaskList, summary="Actualizar una lista de tareas")
def update_list(
...
@router.get("/", response_model=TaskListWithCompletion, summary="Listar tareas de una lista")
def list_tasks(
